...
function PromptGenerator() {
  ...
  const themes = [
    ...
    { key: "socialJustice", label: "Social Justice", icon: "⚖️" },
    { key: "economics", label: "Economics & Inequality", icon: "💰" }
  ];
    ...
    <div style={{ 
      ...
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <p style={{ 
          ...
          Select a theme that matters to you and we'll generate writing prompts to help you craft your open letter.
        </p>
      </div>
      ...
      <div style={{ 
        ...
        {themes.map((theme) => (
          <button
            ...
            onMouseOut={(e) => {
              e.currentTarget.style.background = "linear-gradient(135deg, #800000 0%, #a00000 100%)";
