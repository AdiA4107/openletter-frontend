...
function DashboardStats() {
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 32, marginBottom: 40 }}>
      <div style={{ background: "linear-gradient(135deg, #e8f5e8 0%, #f0f8f0 100%)", color: "#2e7d32", borderRadius: 16, padding: 32, minWidth: 220, textAlign: "center", boxShadow: "0 2px 12px rgba(128,0,0,0.10)", border: "2px solid #800000" }}>
...
function LetterForm({ onSubmit, form, setForm }: { 
  ...
  return (
    <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: 16, background: "#800000", padding: 32, borderRadius: 12, boxShadow: "0 4px 6px rgba(255,255,255,0.05)", color: "#fff", fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
      ...
      />
      <button type="submit" style={{ padding: "12px 24px", background: "linear-gradient(135deg, #e8f5e8 0%, #f0f8f0 100%)", color: "#2e7d32", border: "none", borderRadius: 8, fontSize: 16, fontWeight: 600, cursor: "pointer", transition: "all 0.3s ease" }}>
        Submit Your Letter
      </button>
    </form>
  );
...
function PromptGenerator() {
  ...
  const promptData = {
    education: [
      "Write a letter to the Union Education Minister asking for stronger support systems (scholarships, mentoring) for first-generation college students.",
      "Write to your state government urging them to increase provision to rural schools of internet, electricity, and libraries, as available in urban schools.",
      "Write to policymakers advocating for free menstrual products in all schools to boost attendance for girls.",
      "Write a letter to your school board proposing financial literacy as a mandatory area of evaluation for all students.",
      "Write to NCERT/IB boards suggesting how climate change education should be made compulsory across subject streams.",
      "Write to policymakers asking them to integrate coding and AI into the curriculum in ways that are cognisant of under-funded schools.",
      "Write a letter to UGC urging fairer admission processes in lieu of the current monopoly of expensive coaching centres for competitive examinations (JEE, NEET etc.)",
      "Write to the Prime Minister's Office in favour of foreign universities setting up in India to expand the choice of higher education at a lower cost.",
      "Write to the Dean of a University, calling for transparent admissions processes and adoption of need-blind structures.",
      "Write a letter to your State Education Minister asking for every government school student to receive a subsidised laptop or tablet.",
      "Write to policymakers urging them to mandate learning in regional languages as well as national languages.",
      "Write a letter to your Principal suggesting that student councils be formally included in shaping school policy.",
      "Write to your state board asking for extracurricular activities like arts, sports, and debate to count equally toward student evaluations."
    ],
    climate: [
      "Write a letter to the Ministry of Power urging a clear plan for India to phase out coal and expand renewables.",
      "Write to your state government in favour of installing rooftop solar panels for every government school by 2030, cognisant of the cost.",
      "Write to the Chief Minister asking for stricter enforcement of industrial pollution limits in your State.",
      "Write a letter to your municipal commissioner demanding better waste segregation and door-to-door composting systems.",
      "Write to the Prime Minister asking for an immediate ban on single-use plastics in food delivery and packaging.",
      "Write to your city transport authority urging them to expand electric buses and reduce diesel fleets.",
      "Write a letter to your state water ministry demanding urgent measures against groundwater depletion in rural areas.",
      "Write to policymakers asking for rainwater harvesting to be made mandatory in all new urban buildings.",
      "Write to your municipal leaders urging them to clean and restore local rivers and lakes as community spaces.",
      "Write a letter to the NDMA (National Disaster Management Authority) asking for better climate disaster readiness training in schools.",
      "Write to your state leaders demanding tree-planting programs that focus on native species instead of fast-growing monocultures.",
      "Write to the Ministry of Housing urging climate-resilient housing in flood-prone and cyclone-affected areas.",
      "Write a letter to the Ministry of Environment requesting that youth leaders be formally included in India's climate policy choices.",
      "Write to your city leaders proposing car-free days for certain areas in urban centres to cut emissions and reclaim streets for people.",
      "Write to your state education board asking for practical climate action projects (like school energy audits) to be part of the curriculum."
    ],
    socialJustice: [
      "Write to your state government asking for free sanitary products in all schools to reduce absenteeism among girls.",
      "Write to the Ministry of Women & Child Development demanding stricter implementation of workplace harassment laws for young interns and employees.",
      "Write to your school board proposing mandatory gender-sensitivity workshops for teachers and students.",
      "Write to the Ministry of Social Justice, urging expansion of scholarships for marginalised caste and tribal students.",
      "Write to your city leaders demanding stronger enforcement against caste-based segregation in housing and public services.",
      "Write to the Prime Minister's Office advocating for nationwide protection of minority language schools and cultural centres.",
      "Write to your state police chief demanding better protection for religious minorities during festivals and elections.",
      "Write to your school administration urging inclusion of LGBTQ+ awareness and anti-bullying policies.",
      "Write to the Ministry of Rural Development demanding more effective enforcement of midday meal schemes.",
      "Write to your Municipal Commissioner asking for permanent night shelters for the homeless in your city.",
      "Write to the state health department, urging free basic healthcare camps in rural districts in light of deteriorating health and nutritional conditions.",
      "Write to the Ministry of Law and Justice asking for more accessible legal aid clinics for underprivileged people.",
      "Write to your State Legislative Assembly proposing the establishment of a youth advisory council on social equity issues.",
      "Write to your District Governor demanding rehabilitative programs for juvenile offenders instead of retributive."
    ],
    economics: [
      "Write to the Ministry of Labour asking for a guaranteed first job/apprenticeship program for every college graduate.",
      "Write to your state government demanding more vocational training centres for the rural unemployed.",
      "Write to the Prime Minister urging government investment in green jobs and startups.",
      "Write to the Finance Ministry advocating for higher taxes on luxury goods to be used to fund public schools and hospitals.",
      "Write to your state leaders asking for stricter rules on corporate social responsibility (CSR) spending to ensure it actually benefits poor communities.",
      "Write to your municipal commissioner demanding property tax reforms so slum redevelopment and affordable housing can be funded fairly.",
      "Write to the Ministry of Rural Development, increasing cash transfer programs for families below the poverty line.",
      "Write to your state government demanding free school meals through Class 12, not just in primary school.",
      "Write to policymakers asking for universal access to enforce clean drinking water as a basic economic right.",
      "Write to the Education Ministry urging expansion of government-provided lower-interest loans for first-generation college students.",
      "Write to your state government demanding better digital infrastructure so rural students can access online learning without extra costs.",
      "Write to your local leaders asking for more libraries and community study spaces in underserved areas.",
      "Write to the Ministry of Housing asking for rent control policies to protect migrant workers in big cities.",
      "Write to your state government demanding stronger protections for gig economy workers (delivery, ride-share, domestic help)."
    ]
  };
  ...
  const generatePrompts = (theme: string) => {
    const prompts = promptData[theme as keyof typeof promptData];
    if (prompts && prompts.length >= 2) {
      // Get 2 random prompts
  ...
  return (
    <div style={{ 
      ...
      padding: 40,
      marginBottom: 40,
      boxShadow: "0 8px 32px rgba(128,0,0,0.12)",
      ...
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        <h2 style={{ 
          ...
          🎯 Get Inspired - Choose Your Cause
        </h2>
        ...
        {themes.map((theme) => (
          <button
            ...
            onMouseOver={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 8px 24px rgba(128,0,0,0.25)";
            }}
            onMouseOut={(e) => {
          ...
          <div style={{ 
            ...
            <button
              ...
              onMouseOut={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 4px 12px rgba(128,0,0,0.08)";
              }}
            >
              🔀 Shuffle
            </button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {currentPrompts.map((prompt, index) => (
              <div
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.background = "linear-gradient(145deg, #f8f9fa 0%, #e9ecef 100%)";
                  e.currentTarget.style.transform = "translateY(-1px)";
                  e.currentTarget.style.boxShadow = "0 6px 16px rgba(128,0,0,0.12)";
                }}
                onMouseOut={(e) => {
              ...
              >
                <strong>Option {index + 1}:</strong> {prompt}
              </div>
            ))}
          </div>
          ...
          {selectedPrompt && (
            ...
            >
              <p style={{ 
                ...
                ✅ Great choice! Ready to write your letter?
              </p>
              <p style={{ fontSize: 14, color: "#2e7d32", margin: 0, marginTop: 8 }}>
                Head to the "Get Involved" page to submit your open letter based on this prompt.
              </p>
            </div>
          )}
        </div>
    ...
    <div style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif", background: "#800000", minHeight: "100vh", color: "#fff" }}>
      <main style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
        <section style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          {/* Prompt Generator positioned right after title */}
          <PromptGenerator />
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: 24 }}>
          ...
          <div style={{ 
            ...
            {letters.map((letter, idx) => (
              ...
              <div style={{ marginBottom: 6, lineHeight: 1.6 }}><b>Purpose:</b> {letter.purpose}</div>
              <div style={{ marginBottom: 8, lineHeight: 1.6 }}><b>Impact:</b> {letter.impact}</div>
              <div 
                style={{ 
                  background: "#f8f8fa", 
                  color: MAROON, 
                ...
                onMouseOver={(e) => {
                  ...
                  e.currentTarget.style.transform = "translateY(-1px)";
                  e.currentTarget.style.boxShadow = "0 2px 8px rgba(128,0,0,0.15)";
                }}
                onMouseOut={(e) => {
              ...
              >
                ...
                <span style={{ marginLeft: 8 }}>
                  {expandedExcerpts[idx] ? letter.excerpt : truncateText(letter.excerpt)}
                </span>
                <div style={{
                  position: "absolute",
                  bottom: 8,
        ...
        <div style={{ 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ 
              ...
              boxShadow: "0 4px 12px rgba(128,0,0,0.08)"
            }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                <div>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>TO:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>Prime Minister Modi</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>FROM:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>Aarushi R.</div>
                </div>
              </div>
              <div style={{ 
                fontSize: 16, 
                ...
                <strong>Summary:</strong> Sir, we the youth of India, are ready to work hard, compete fairly, and contribute meaningfully to the nation. All we ask for is a level playing field. Reforming the reservation system to include lower-income earners is about ensuring that support reaches the right hands, and that no deserving student is left behind.
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                <div>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>TO:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>The City of Mumbai</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>FROM:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>Lineysha B.</div>
                </div>
              </div>
              <div style={{ 
                fontSize: 16, 
                ...
                <strong>Summary:</strong> Why are there so many cautions when a girl is growing up? We've become so accustomed to feeling uncomfortable, unsafe, or unheard that we've begun to accept it as "normal". It isn't and it shouldn't be, either. I want to be intelligent without coming across as "too ambitious." When I'm just leaving for school or returning home, I want to feel safe, not brave.
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                <div>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>TO:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>Leaders of India</div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 14, color: "#666", marginBottom: 4 }}>FROM:</div>
                  <div style={{ fontSize: 18, fontWeight: 600, color: "#800000" }}>Praghyaan B.</div>
                </div>
              </div>
              <div style={{ 
                fontSize: 16, 
                ...
                <strong>Summary:</strong> We need your leadership, Mr. Krishnamurthy, to align Flipkart's sustainability ambitions with practical action on the ground. By doing so, you'll not only keep our streets clear and prevent flooding, but also inspire millions of customers to adopt greener e-commerce and help our nation build a cleaner, more resilient future. I hope you will consider this appeal on behalf of thousands of concerned Indians.
              </div>
            </div>
          </div>
        </div>
